...
NSString * _Nonnull const NatTypeDescription[] = {
    [NatTypeUdpBlocked] = @"UdpBlocked",
    [NatTypeOpenInternet] = @"OpenInternet",
    [NatTypeSymmetricUdpFirewall] = @"SymmetricUdpFirewall",
